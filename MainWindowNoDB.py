...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow, receiveSerialThread):
        ...
        self.close_button.setGeometry(QtCore.QRect(1210, 740, 135, 40))
    ...
    def handle_sensor_data(self, data, type):
        ...
        if self.distance_reading_received and self.temp_reading_received:
            ...
            if abs(temp_time - dist_time) < 0.1:
                ...
                if(not(self.temp_window == None)):
                    if(self.temp_window.isVisible()):
                        self.temp_window.update_data(combined_data)

                if(not(self.distance_window == None)):
                    if(self.distance_window.isVisible()):
                        self.distance_window.update_data(combined_data)
